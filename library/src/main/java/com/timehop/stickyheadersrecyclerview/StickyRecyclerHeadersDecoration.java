...
public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {
    ...
    public static int ITEM_OFFSET = 50;
    ...
    private StickyRecyclerHeadersDecoration(StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider, DimensionCalculator dimensionCalculator, HeaderRenderer headerRenderer, HeaderProvider headerProvider) {
        this(adapter, headerRenderer, orientationProvider, dimensionCalculator, headerProvider, new HeaderPositionCalculator(adapter, headerProvider, orientationProvider,
                dimensionCalculator));
    }
...
//      itemOffsets.top = header.getHeight();
            Log.d("item off sets.top ", itemOffsets.top + " items top inside sticky headers decoration");
        } else {
    ...
    public void onDrawOver(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (hasStickyHeader || mHeaderPositionCalculator.hasNewHeader(position)) {
                ...
                Log.d("header offset", "header off set onDrawOver" + headerOffset.top);
